...
public class Script_Instance : GH_ScriptInstance
{
		...
		ref object floorEnvelope)
    {
        ...
        var extrusion = region.Faces[0].CreateExtrusion(spine, true);

        // translate up by floorHeight + floorThickness
        var translation = Transform.Translation(0, 0, floorHeight + floorThickness);
        extrusion.Transform(translation);

        floorEnvelope = extrusion;
    }
}
